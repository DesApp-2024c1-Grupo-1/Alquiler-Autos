  ...
  const promise = new Promise((resolve, reject) =>{
    setTimeout(() => {
      resolve([
        ...
        { id: 2, name: 'Ford Falcon', brand: 'Ford', year: 1980, km: 200000, color: 'verde', price: 150000, image: image,transmision: 'manual', combustible: 'nafta', ac: true, capacidad: 4, patente: 'ABC123' },
        { id: 3, name: 'Chevrolet Corsa', brand: 'Chevrolet', year: 2000, km: 50000, color: 'azul', price: 200000, image: image,transmision: 'Automatico', combustible: 'electrico', ac: true, capacidad: 4, patente: 'ABC123' },
